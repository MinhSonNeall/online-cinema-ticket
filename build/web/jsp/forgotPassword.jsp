...
<html lang="vi">
    <head>
        ...
        <title>Forgot Password - Online Cinema Ticket</title>
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid mt-4">
                                                <button class="btn btn-primary-custom btn-lg" type="submit">Gửi OTP</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-between">
                                            <a href="<c:url value='/login'/>" class="link-secondary text-decoration-none">Đã nhớ lại mật khẩu? Đặng nhập</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
