<%-- 
    Document   : login
    Created on : May 22, 2025, 6:53:25 PM
    Author     : HP
--%>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex gap-3 flex-column">
                                            <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:9999/OnlineCinemaTicket/GoogleLogin/loginGoogle&response_type=code&client_id=266099726397-t6uec8o1gni790qbt50cip54ur00dq1o.apps.googleusercontent.com&approval_prompt=force" class="btn bsb-btn-xl btn-danger">
